    ...
    <main class="main" id="top">
        <div class="row vh-100 g-0">
            <div class="col-lg-6 position-relative d-none d-lg-block">
                <div class="bg-holder" style="background-image:url(../../../assets/img/bg/forgot.png);"></div>
                <!--/.bg-holder-->
            </div>
            <div class="col-lg-6">
                <div class="row flex-center h-100 g-0 px-4 px-sm-0">
                    ...
                    <div id="alertID"></div>
                        ...
                        <a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
                            <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block"><img src="../../../assets/img/icons/owwa.png" alt="phoenix" width="58" /></div>
                        </a>
                        <div class="text-center">
                            <h4 class="text-body-highlight">OTP Request</h4>
                            <p class="text-body-tertiary mb-5">Enter your otp here to grant to update password <br class="d-xxl-none" />you a reset link</p>
                            <form class="d-flex align-items-center mb-5" id="sendOtp">
                                <input class="form-control flex-1" id="otp" type="text" placeholder="Otp" required /><button class="btn btn-primary ms-2" type="submit">Send<span class="fas fa-chevron-right ms-2"></span></button></form>
...
const api = new APIClient({ url: "<?php echo base_url("/auth/verify") ?>" });


document.querySelector("#sendOtp").addEventListener("submit",function(e) {
    e.preventDefault();
    let res = api.getPOST({
        data: { 
...
<!-- Mirrored from prium.github.io/phoenix/v1.14.0/pages/authentication/split/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Feb 2024 02:18:52 GMT -->
