                ...
                <div class="row flex-center h-100 g-0 px-4 px-sm-0">
                    ...
                    <div id="alertID"></div>
                        ...
                        <div class="text-center">
                            ...
                            <form class="d-flex align-items-center mb-5" id="sendVerification">
                                <input class="form-control flex-1" id="email" type="email" placeholder="Email" required /><button class="btn btn-primary ms-2" type="submit">Send<span class="fas fa-chevron-right ms-2"></span></button></form>
...
const api = new APIClient({ url: "<?php echo base_url("/auth/send") ?>" });


document.querySelector("#sendVerification").addEventListener("submit",function(e) {
    e.preventDefault();
    let res = api.getPOST({
        data: { 
