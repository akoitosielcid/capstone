                ...
                <div class="card position-relative border-0">
                  ...
                  <div class="overflow-auto scrollbar" style="height: 10rem;">
                    <ul class="nav d-flex flex-column mb-2 pb-1">
                      ...
                      <li class="nav-item"><a class="nav-link px-3" href="#!"> <span class="me-2 text-body" data-feather="settings"></span>Settings </a></li>
                  ...
                  <div class="card-footer p-3 border-top border-translucent">
                    ...
                    <!-- <div class="my-2 text-center fw-bold fs-10 text-body-quaternary"><a class="text-body-quaternary me-1" href="#!">Privacy policy</a>&bull;<a class="text-body-quaternary mx-1" href="#!">Terms</a>&bull;<a class="text-body-quaternary ms-1" href="#!">Cookies</a>-->
                    </div>
                </div>
              </div>
            </li> 
                      ...
                      <div class="">
                        <div class="d-flex align-items-center mb-3"><a href="profile.html">
                          ...
                          <div class="flex-1"><a class="fw-bold mb-0 text-body-emphasis" href="profile.html">Zingko Kudobum</a>
                            <p class="fs-10 mb-0 text-body-tertiary text-opacity-85 fw-semibold">35 mins ago</p>
                          </div>
