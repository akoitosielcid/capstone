                    ...
                    <div class="card-body d-flex flex-column justify-content-between pb-3">
                      <div class="row align-items-center g-5 mb-3 text-center text-sm-start">
                        <div class="col-12 col-sm-auto mb-sm-2">
                          <div class="avatar avatar-5xl"><img class="rounded-circle" src="57.webp" alt="" /></div>
                        </div>
                        <div class="col-12 col-sm-auto flex-1">
                          <div class="col-12 col-sm-auto flex-1 d-sm-block"><br>
                          <h3>Alice Marquez Agustin</h3>

                          <table class="table table-sm">
                            <tbody>
                              <tr>
                                <th scope="row">OFW ID:</th>
                                <td>1</td>
                              </tr>
                              <tr>
                                <th scope="row">Relationship to Scholar:</th>
                                <td>Sister</td>
                              </tr>
                              <tr>
                                <th scope="row">Category:</th>
                                <td colspan="2">Land-based</td>
                              </tr>
                            </tbody>
                          </table>
                                  <div class="row g-2">
                                    <a class="nav-link label-1" href="edit-basic.php" role="button" data-bs-toggle="" aria-expanded="false">
                                      <button class="btn btn-warning lh-1 btn-sm d-block" type="button" href="edit-basic.php"><span class="far fa-edit me-2" data-fa-transform="shrink-3 down-2"></span><span class="ms-1">Request Edit</span>
                                      </button>
                                    </a>
                                  </div>                    
                        </div>
