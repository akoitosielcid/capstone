...
<!-- Mirrored from prium.github.io/phoenix/v1.14.0/pages/authentication/split/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Feb 2024 02:18:52 GMT -->
<!-- Added by HTTrack -->
    ...
    <main class="main" id="top">
        <div class="row vh-100 g-0">
            <div class="col-lg-6 position-relative d-none d-lg-block">
                <div class="bg-holder" style="background-image:url(../../../assets/img/bg/reset.png);"></div>
                <!--/.bg-holder-->
            </div>
            <div class="col-lg-6">
                <div class="row flex-center h-100 g-0 px-4 px-sm-0">
                    <div class="col col-sm-6 col-lg-7 col-xl-6">
                        ...
                        <div class="text-center mb-6">
                            ...
                            <form class="mt-5"><input class="form-control mb-2" id="password" type="password" placeholder="Type new password" /><input class="form-control mb-4" id="confirmPassword" type="password" placeholder="Cofirm new password" /><button class="btn btn-primary w-100"
