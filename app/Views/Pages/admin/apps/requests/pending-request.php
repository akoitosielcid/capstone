...
<!-- Mirrored from prium.github.io/phoenix/v1.14.0/apps/project-management/project-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Feb 2024 02:16:00 GMT -->
            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper">
                  ...
                  <div class="nav-item-wrapper"><a class="nav-link label-1 active" href="pending-request.php" role="button" data-bs-toggle="" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret" id="navbarDropdownNotfication" aria-labelledby="navbarDropdownNotfication">
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent border-0">
                    <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a class="fw-bolder" href="notifications.php">Notification history</a></div>
                  </div>
                </div>
              </div>
            </li>
          ...
          <div id="projectSummary" data-list='{"valueNames":["projectName","assigness","start","deadline","task","projectprogress","status","action"],"page":6,"pagination":true}'>
            <div class="row mb-4 gx-6 gy-3 align-items-center">
              <div class="col-auto">
                ...
                <!--Number beside the Pending Requests indicates the number of requests that the admin haven't check-->
                <h2 class="mb-0">Pending Requests</h2>
              </div>
            ...
            <div class="table-responsive scrollbar">
              <table class="table fs-9 mb-0 border-top border-translucent">
                <thead>
                  <tr>
                    <th class="sort white-space-wrap align-middle ps-0" scope="col" data-sort="projectName" style="width:30%;">BODY</th>
                    <th class="sort align-middle ps-3" scope="col" data-sort="assigness" style="width:15%;">CREATOR</th>
                    <th class="sort align-middle ps-3" scope="col" data-sort="start" style="width:15%;">DATE REQUESTED</th>
                    <th class="sort align-middle ps-3" scope="col" data-sort="start" style="width:15%;">PROVINCE</th>
                    <th class="sort align-middle ps-3" scope="col" data-sort="start" style="width:15%;">REMARKS</th>
                ...
                <tbody class="list" id="project-list-table-body">
                  <tr class="position-static">
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">Evan Mark Simons has an edit request. Check and validate it now.</td>
                         
                           
                            
                    <td class="align-middle white-space-nowrap start ps-3 py-4">
                      <p class="mb-0 fs-9 text-body">Evan Mark Simons</p>
                    </td>
                    <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                      <p class="mb-0 fs-9 text-body">May 21, 2028</p>
                    </td>
                    <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                      <p class="mb-0 fs-9 text-body">Palawan</p>
                    </td>
                    <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                      <p class="mb-0 fs-9 text-body"></p>
                    </td>
                  ...
                  <tr class="position-static">
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">Jenna Mae Villas has an edit request. Check and validate now</td>
   
                    <td class="align-middle white-space-nowrap start ps-3 py-4">
                      <p class="mb-0 fs-9 text-body">Jenna Mae Villas</p>
                    </td>
                    <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                      <p class="mb-0 fs-9 text-body">Sep 15, 2022</p>
                    </td>
                    <td class="align-middle white-space-nowrap task ps-3 py-4">
                      <p class="fw-bo text-body fs-9 mb-0">Marinduque</p>
                    </td>
                    <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                      <p class="mb-0 fs-9 text-body"></p>
                    </td>
...
<!-- Mirrored from prium.github.io/phoenix/v1.14.0/apps/project-management/project-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Feb 2024 02:16:05 GMT -->
</html>