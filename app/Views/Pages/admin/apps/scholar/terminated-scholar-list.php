     ...
     <div class="content">
      ...
      <div class="mb-9">
        ...
        <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
          ...
          <li class="nav-item"><a class="nav-link " href="terminated-scholar-list.php"><span>Terminated Scholar </span><span class="text-body-tertiary fw-semibold">(8)</span></a></li>
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort align-middle ps-4 pe-5 border-end border-translucent" scope="col" data-sort="contact" style="width:15%;">
                    <div class="d-inline-flex flex-center">
                      <div class="d-flex align-items-center px-1 py-1 bg-info-subtle rounded me-2"><span class="text-info-dark" ></span></div><span>Date of Termination</span>
                    </div>
                  </th>
                  <th class="sort align-middle ps-4 pe-5 border-end border-translucent" scope="col" data-sort="company" style="width:15%;">
                    <div class="d-inline-flex flex-center">
                      <div class="d-flex align-items-center px-1 py-1"><span class="text-warning-dark"></span></div><span>Remarks</span>
                    </div>
                  </th>
              ...
              <tbody class="list" id="leal-tables-body">
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td class="name align-middle white-space-nowrap ps-0">
                      <div><a href="view-submitted-documents.php">Kristen Lowell</a>
                      </div>
                    </div>
                  </td>
                  <td class="email align-middle white-space-nowrap fw-semibold ps-4 border-end border-translucent">lowell@gmail.com</td>
                  <td class="phone align-middle white-space-nowrap fw-semibold ps-4 border-end border-translucent">EDSP</td>
                  <td class="contact align-middle white-space-nowrap ps-4 border-end border-translucent fw-semibold text-body-highlight">March 12, 2024</td>
                  <td class="contact align-middle white-space-nowrap ps-4 border-end border-translucent fw-semibold text-body-highlight">Migrated abroad</td>
