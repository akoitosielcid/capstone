     ...
     <div class="content">
      ...
      <div class="mb-9">
        ...
        <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
          <li class="nav-item"><a class="nav-link active" aria-current="page" href="scholar-list.php"><span>Active Scholar </span><span class="text-body-tertiary fw-semibold">(500)</span></a></li>
          ...
          <li class="nav-item"><a class="nav-link " href="graduated-scholar-list.php"><span>Graduated Scholar </span><span class="text-body-tertiary fw-semibold">(17)</span></a></li>
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort align-middle ps-4 pe-5 border-end border-translucent" scope="col" data-sort="company" style="width:15%;">
                    <div class="d-inline-flex flex-center">
                      <div class="d-flex align-items-center px-1 py-1 bg-warning-subtle rounded me-2"><span class="text-warning-dark"></span></div><span>End of Contract Date</span>
                    </div>
                  </th>
              ...
              <tbody class="list" id="leal-tables-body">
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td class="name align-middle white-space-nowrap ps-0">
                      <div><a href="view-submitted-documents.php">Janella Jones</a>
                      </div>
                    </div>
                  </td>
                  <td class="email align-middle white-space-nowrap fw-semibold ps-4 border-end border-translucent">jjones@gmail.com</td>
                  ...
                  <td class="contact align-middle white-space-nowrap ps-4 border-end border-translucent fw-semibold text-body-highlight">May 30, 2023</td>
                ...
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td class="name align-middle white-space-nowrap ps-0">
                    <div class="d-flex align-items-center">
                      <div><a href="view-submitted-documents.php">James McKnill</a>
                      </div>
                    </div>
                  </td>
                  <td class="email align-middle white-space-nowrap fw-semibold ps-4 border-end border-translucent">jmchnll@gmail.com</td>
                  <td class="phone align-middle white-space-nowrap fw-semibold ps-4 border-end border-translucent">ELAP</td>
                  ...
                  <td class="contact align-middle white-space-nowrap ps-4 border-end border-translucent fw-semibold text-body-highlight">June 12, 2023</td>
                  <td class="date align-middle white-space-nowrap text-body-tertiary text-opacity-85 ps-4 text-body-tertiary">                      
                    <button title="View Information" class="btn btn-primary me-1 mb-1" type="button"><span class="fas fa-eye"></span></button>
                  </td>
