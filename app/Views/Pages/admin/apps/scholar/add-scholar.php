          ...
          <div class="navbar-vertical-content">
            ...
            <li class="nav-item">
                ...
                <!---->    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-CRM">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="add-scholar.php" data-bs-toggle="" aria-expanded="false">
          ...
          <div class="row">
            <div class="col-xl-9">
              <div class="d-sm-flex justify-content-between">
                <h2 class="mb-4">Add New Scholar</h2>
                <div class="d-flex mb-3"><button class="btn btn-phoenix-primary me-2 px-6">Cancel</button><button class="btn btn-primary">Add Scholar</button></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xl-9">
            <div class="col-sm-6 col-md-4">
              <div class="form-floating"><select class="form-select" id="floatingSelectStatus">
                  ...
                  <option value="1">ODSP</option>
                  <option value="1">ODSP+</option>
                  <option value="2">EDSP</option>
                  <option value="3">EDSP+</option>
                  <option value="3">ELAP</option>
                </select><label for="floatingSelectStatus">Program </label></div>
            </div>
            <p></p>
            ...
            <form class="row g-3 mb-9">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputFirstname" type="text" placeholder="Middle name" /><label for="floatingInputFirstname">Middle name</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputGender" type="text" placeholder="Gender" /><label for="floatingInputGender">Gender</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputBirthdate" type="text" placeholder="mm/dd/yyyy" /><label for="floatingInputBirthdate">Birthdate</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputContact" type="tel" placeholder="Contact No."/><label for="floatingInputContact">Contact</label></div>
              </div>
              
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><select class="form-select" id="floatingSelectIndustry">
                    <option selected="selected"></option>
                    <option value="1">Oriental Mindoro</option>
                    <option value="1">Occidental Mindoro</option>
                    <option value="2">Marinduque</option>
                    <option value="3">Romblon</option>
                    <option value="3">Palawan</option>
                  </select><label for="floatingSelectIndustry">Province</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputMunicipality" type="tel" placeholder="Municipality"/><label for="floatingInputMunicipality">Municipality</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputBarangay" type="tel" placeholder="Barangay"/><label for="floatingInputBarangay">Barangay</label></div>
              </div>
              
              <h4 class="mt-6">OFW Information</h4>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputLastname" type="text" placeholder="Lastname" /><label for="floatingInputLastname">Lastname</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputFirstname" type="text" placeholder="Firstname" /><label for="floatingInputFirstname">Firstname</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputMiddlename" type="text" placeholder="Middlename" /><label for="floatingInputMiddlename">Middlename</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputelationship" type="text" placeholder="Relationship to the Scholar" /><label for="floatingInputRelationship">Relationship to the Scholar</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><input class="form-control" id="floatingInputEmail" type="text" placeholder="Email" /><label for="floatingInputEmail">Email</label></div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-floating"><select class="form-select" id="floatingSelectCity">
                    <option selected="selected"></option>
                    <option value="1">Land-based</option>
                    <option value="2">Sea-based</option>
                  </select><label for="floatingSelectCity">Category</label></div>
              </div>
              </form>
          </div>
        </div>
