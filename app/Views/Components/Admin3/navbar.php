...
<div class="wrapper ">
  <div class="sidebar" data-color="azure" data-background-color="white"
    data-image="<?php echo base_url("asset/admin/adminmenu/assets/img/sidebar-1.jpg")?>">
    <!--
    ...
    <div class="sidebar-wrapper">
      <ul class="nav">
        ...
        <li class="nav-item <?php echo ($currentpage  == 'announcement') ? 'active' : ''; ?>">
          <a class="nav-link" href="<?php echo base_url("admin/announcement")?>">
            <p>Announcements</p>
          </a>
        </li>

        <li class="nav-item <?php echo ($currentpage  == 'modstudent') ? 'active' : ''; ?>">
...
//  print_r($cur->count);
      ?>
            <p>Notification<span class="notif_count"
                style=" background-color: <?php echo (!empty($cur) && $cur->count > 0) ? '#FF2E2E' : 'transparent'; ?>">
        ...
        <div class="dropdown">
          <li class="nav-item  <?php echo ($currentpage == 'reports') ? 'active' : ''; ?>">
            <a class="nav-link dropdown-toggle" href="#" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false">
              Reports
            </a>
        ...
        <div class="collapse navbar-collapse justify-content-end">
          <ul class="navbar-nav">
            ...
            <a href="<?php echo base_url("admin/modules/notification/index.php")?>">
              <span
                class="badge rounded-pill badge-notification <?php echo (!empty($cur) && $cur->count > 0) ? 'bg-danger text-white' : 'bg-transparent text-gray'; ?> ">
                <?php echo (!empty($cur)) ? $cur->count : ""; ?>
              </span>
            </a>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                <a class="dropdown-item"
                  href="<?php echo base_url("admin/modules/user/index.php?view=edit&id=".$id."")?>">Profile</a>
